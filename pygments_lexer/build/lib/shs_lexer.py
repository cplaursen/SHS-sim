...
class SHSLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'\b(SHP|Variables|Constants|Enums)\b', Keyword.Namespace),        # Block Keywords
            (r'\b(choice|if|else|while|abort|skip|dt|dW|loop)\b', Keyword.Reserved),  # Control flow and functions
